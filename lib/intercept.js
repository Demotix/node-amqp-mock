...
module.exports = function(connectionOptions) { // TODO: filter interceptions by connection options
    ...
    cp.queue = function(name){
        ...
        // Call the original bind function and call callback directly.
        var resultBind = result.bind;
        result.bind = function(exchange, routingKey, cb) {
          resultBind.apply(result, arguments);
          if (cb) {
            cb();
          }
        };
